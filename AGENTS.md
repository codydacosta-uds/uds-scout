...
- Red reserved for actual failures and errors, not general interaction or routine review work
...
- Using red for normal links, navigation, focus, or non-error actions
...
Use concise, direct engineering language. Lead with state and action:
...
Renovate updates must be authored by Renovate and use a `renovate/*` source branch.
