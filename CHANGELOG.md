...
- First-run setup no longer asks for optional Defense Unicorns Registry credentials; private-registry connections remain available from Workspace settings after onboarding.
